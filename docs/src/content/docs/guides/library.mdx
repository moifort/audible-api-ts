...
|--------|------|---------|-------------|
| `categoryId` | `string` | *required* | Audible category ID |
...
| `numResults` | `number` | `50` | Max 50 per request |
| `page` | `number` | `1` | Page number |

<Aside type="tip">
  Category IDs are locale-specific. For example, Science Fiction is `18580628011` on audible.com but `21228885031` on audible.fr.
</Aside>
...
**Output:**
```
1. Project Hail Mary — 4.9/5 (82341 votes) — Andy Weir
2. Dune — 4.7/5 (45210 votes) — Frank Herbert
3. The Hitchhiker's Guide to the Galaxy — 4.6/5 (38102 votes) — Douglas Adams
```
